...
describe('GET /todos/:id', () => {
  ...
  it('should return 401 todo doc is created by other user', (done) => {
    request(app)
...
describe('DELETE /todos/:id', () => {
  ...
  it('should return 404 if todo doc is created by other user', (done) => {
...
describe('PATCH /todos/:id', () => {
  ...
  it('should update todo doc', (done) => {
    let hexId = todos[1]._id.toHexString();
    let text = 'This should be the newer text';
...
describe('GET /users', () => {
  ...
  it('should return 400 if NOT authenticated', (done) => {
    request(app)
      .post('/users')
      .send({email: 'testexample.com', password: 'a!'})
      .expect(400)
      .end(done);
  });
  ...
  it('should return 400 if email is in use', (done) => {
    request(app)
      .post('/users')
      .send({email: users[0].email, password: 'password!234'})
      .expect(400)
      .end(done);
  });
});
